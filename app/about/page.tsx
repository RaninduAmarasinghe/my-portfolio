...
import { SiSpringboot, SiMongodb, SiPostman, SiNextdotjs, SiDotnet, SiN8N, SiOllama  } from "react-icons/si";
    ...
    <section className="relative min-h-screen text-white px-6 md:px-24 py-24 md:py-32 overflow-hidden bg-[#0a0a0a]">
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 max-w-4xl">
          ...
          <Skill icon={<SiDotnet />} name=".NET Core" />
          ...
          <Skill icon={<SiOllama />} name="Ollama" />
          <Skill icon={<SiN8N />} name="n8n" />
